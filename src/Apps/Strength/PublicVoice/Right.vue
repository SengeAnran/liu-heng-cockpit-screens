  ...
  <div class="right">
    ...
    <div class="comment-list">
      <div class="item" v-for="(item, index) in list" :key="index">
        ...
        <div class="desc">
          <div class="title" :title="item.title" @click="onClick(item.link)">{{ item.title.length >22? item.title.slice(0,20)+'...' : item.title }}</div>
          <div>
      ...
      list0: [
        {
          ...
          content: '“美丽北仑”是“三个北仑”建设的重要内容之一。“十四五”时期，以“美丽北仑”为引领，点面结合，片区协同，着力做好全域空间调整优化，全面形成“一核引领、两翼并进、三区协同、多点联动”城市空间总体布局，加……',
          ...
          content: '心百年征程波澜壮阔， 百年初心历久弥坚。在中国共产党成立100周年之际，舟山市税务系统开展“最佳基层党组织”“最佳党支部书记”“最佳共产党员”等“五最佳”评选活动，深入探寻他们的故事，感悟共产党人的初……',
          ...
          content: '为深入贯彻落实习近平总书记关于党史学习教育重要讲话精神，6月25日上午，舟山检测党支部全体党员前往六横岛“东海游击总队”纪念馆，开展“学党史、守初心”主题党日活动。 通过纪念馆的实物展示和老同志的讲解……',
          ...
          content: '好 家 风 近期，中远海运重工纪委在全系统内组织开展以“锤炼作风品质  助力企业发展”为主题的作风建设专项大检查，通过对作风建设七个方面的专项检查，推动营造求真务实、清正廉洁的新风正气，确保全体党员以……',
          ...
          content: '新规定·续 航行规则知多少    下列船舶应尽可能避免在长江江苏段 夜间航行：  （一）船龄 26 年及以上的油船、散装液体化学品船， 但双底双壳的油船及达到 2 型船舶及以上标准的散装液体 化学品船……',
          ...
          content: '因为你的分享、点赞、在看 我足足的精气神儿！ 2012年通车的汉宜铁路结束了荆州国家铁路空白的历史，荆州火车站也成为了荆州人出行的窗口。近期，荆州火车站已升级为铁路一等站，成为与宜昌东、襄阳等铁路枢纽……',
          ...
          content: '微信公众号更改了推送规则，如您不想错过精彩内容，请将“上海工地”公众号设为星标，并在文尾点击"收藏""在看""赞"，可让您第一时间看到我们。 本文由隧道股份上海路桥投稿，如需转载请注明出处。 今天，陆……',
          ...
          content: '最近，普陀区六横镇原平峧砖瓦厂窑潭里来了四位美丽的客人，就是Ta们~ 四只黑天鹅在水里游弋 有的在“用餐”，有的在“梳洗” 好美好美    不过，前几天，其中一只黑天鹅险些受伤。平峧村……',
          ...
          content: '（播报人：李鑫） 横琴新区 6月25日上午，横琴新区荷塘社区党委、社区妇联、巾帼文明岗联合开展“凝心聚力 共话发展”巾帼座谈会，15名巾帼志愿者、社区骨干参与座谈。活动通过党史知识问答比赛、社区治理探……',
          ...
          content: '近日，荣盛石化董秘在与投资者互动中透露：目前浙石化二期处于试生产阶段。与此同时，6月10日，浙江舟山群岛新区六横管理委员会官网对《舟山绿色石化基地拓展区总体发展规划》环境影响评价进行了第二次公示。 今……',
      ...
      list1: [
        {
          ...
          type: '正面',
          date: '2021-06-28 22:25',
          content: '百年征程波澜壮阔， 百年初心历久弥坚。在中国共产党成立100周年之际，舟山市税务系统开展“最佳基层党组织”“最佳党支部书记”“最佳共产党员”等“五最佳”评选活动，深入探寻他们的故事，感悟共产党人的初心……',
          link: 'http://mp.weixin.qq.com/s?__biz=MzA3OTIwNjk4MQ==&mid=2650455912&idx=2&sn=bb0ad6f6a53fe398dbe31f20f8ad377a&scene=0',
          source: '微信',
          media: '微信',
        }, {
