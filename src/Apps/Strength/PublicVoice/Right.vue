      ...
      <div class="item" v-for="(item, index) in list" :key="index">
        <div class="name">
          <img
            :src="
              item.type == '正面'
                ? require('./img/shili/zhengmianshijian.png')
                : item.type == '负面'
                ? require('./img/shili/fumianshijian.png')
                : require('./img/shili/zhongxingshijian.png')
            "
          />
          <!-- <span>{{ item.type }}</span> -->
          <!-- ./img/shili/fumianshijian.pngreq
          -->
        </div>
        <div class="desc">
