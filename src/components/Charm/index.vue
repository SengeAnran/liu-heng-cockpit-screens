  ...
  data() {
    return {
      ...
      contain1: {
        ...
        title: '荷花小区',
        content:
          '五星村位六横岛的西北部，三面环山，南面是港湾平原。由三个自然岙（东坑、中岙、西坑）和一个外迁小区（水库扩容迁至山西村沈家）组成，由十九个村民小组，三百九十二户农户，1274人组成。其中五星村党支部有党员60人。集体经济以养殖和茶叶种植为主，五星三个自然岙的三条溪流汇入大水库，犹如母亲的乳汁哺育着五星近一千三百人口',
      },
      contain2: [
